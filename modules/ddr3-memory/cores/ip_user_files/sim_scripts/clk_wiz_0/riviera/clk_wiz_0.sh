...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/JMSudar/Code/alchitry-learning-module/modules/ddr3-memory/cores/managed_ip_project/managed_ip_project.cache/compile_simlib/riviera"
  fi
  if [[ ($lib_map_path != "") ]]; then
