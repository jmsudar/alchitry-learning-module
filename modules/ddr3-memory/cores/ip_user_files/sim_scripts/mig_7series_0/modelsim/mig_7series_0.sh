...
#
# Script generated by Vivado on Tue Jul 15 17:26:33 -0700 2025
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/JMSudar/Code/alchitry-learning-module/modules/ddr3-memory/cores/managed_ip_project/managed_ip_project.cache/compile_simlib/modelsim"
  fi
